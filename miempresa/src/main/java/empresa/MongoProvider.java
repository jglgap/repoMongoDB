...
public final class MongoProvider implements AutoCloseable {
    ...
    private final MongoCollection<Document> empleados;
    ...
    public MongoProvider() {
        ...
        String dbName = envOrDefault("MONGO_DB", "CacharrosGeri");
        String colName = envOrDefault("MONGO_COLLECTION", "Personal");
        ...
        this.empleados = database.getCollection(colName);
    }
